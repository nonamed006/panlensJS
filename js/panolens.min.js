(function(h, e) {
    ...
    function z(a, b, c) {
        ...
        c = function(d) {
            if (this.material) {
                ...
                c.copy(this.scale);
                this.scaleUpAnimation = (new r.Tween(this.scale)).to({
                    x: 1.3 * c.x,
                    y: 1.3 * c.y
                }, 500).easing(r.Easing.Elastic.Out);
                this.scaleDownAnimation = (new r.Tween(this.scale)).to({
                    x: c.x,
                    y: c.y
                }, 500).easing(r.Easing.Elastic.Out);
                this.material.map = d;
        ...
        this.showAnimation = (new r.Tween(this.material)).to({
            opacity: 1
        }, 500).onStart(this.enableRaycast.bind(this, !0)).easing(r.Easing.Quartic.Out);
        this.hideAnimation = (new r.Tween(this.material)).to({
            opacity: 0
        }, 500).onStart(this.enableRaycast.bind(this, !1)).easing(r.Easing.Quartic.Out);
        this.addEventListener("click", this.onClick);
        this.addEventListener("hover", this.onHover);
        this.addEventListener("hoverenter", this.onHoverStart);
        this.addEventListener("hoverleave",
            this.onHoverEnd);
    ...
    function I(a) {
        ...
        this.TOUCH_ENABLED = !!("ontouchstart" in window || window.DocumentTouch &&
    ...
    function P(a) {
        ...
        this.maxW =
            Math.max(b.getParameter(b.MAX_TEXTURE_SIZE), this.maxW);
    ...
    function ba(a, b) {
        function c(a) {
            ...
            if (!1 !== f.enabled) {
                ...
                x !== w.NONE && (document.addEventListener("mousemove", d, !1), document.addEventListener("mouseup", g, !1), f.dispatchEvent(O));
                f.update()
            }
        }
        ...
        function d(a) {
            if (!1 !== f.enabled) {
                ...
                if (x === w.ROTATE) {
                    ...
                    D.copy(h);
                    G && (K = a.clientX - G.clientX,
                        L = a.clientY - G.clientY);
                    G = a
                } else if (x === w.DOLLY) {
                    if (!0 === f.noZoom) return;
        ...
        function g() {
            Q = !0;
            G = void 0;
            !1 !== f.enabled && (document.removeEventListener("mousemove", d, !1), document.removeEventListener("mouseup", g, !1), f.dispatchEvent(P), x = w.NONE)
        }
        ...
        function k(a) {
            if (!1 !== f.enabled && !0 !==
                ...
                0 > d ? (f.object.fov = f.object.fov < f.maxFov ? f.object.fov + 1 : f.maxFov, f.object.updateProjectionMatrix()) : 0 < d && (f.object.fov = f.object.fov > f.minFov ? f.object.fov - 1 : f.minFov, f.object.updateProjectionMatrix());
                f.update();
                f.dispatchEvent(V);
                f.dispatchEvent(O);
                f.dispatchEvent(P)
        ...
        function m(a) {
            if (!1 !== f.enabled && !0 !== f.noKeys && !0 !== f.noRotate) {
                ...
                if (I || J || X || Y) Q = !0, I && (L = -f.rotateSpeed * f.momentumKeydownFactor), J && (L = f.rotateSpeed * f.momentumKeydownFactor), X && (K = -f.rotateSpeed * f.momentumKeydownFactor), Y && (K = f.rotateSpeed * f.momentumKeydownFactor)
            }
        }
        ...
        this.pan = function(a, d) {
            ...
            } else f.object instanceof e.OrthographicCamera ? (f.panLeft(a * (f.object.right - f.object.left) / b.clientWidth), f.panUp(d * (f.object.top - f.object.bottom) / b.clientHeight)) : console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.")
        };
        this.momentum = function() {
            Q && (1E-4 > Math.abs(K) && 1E-4 > Math.abs(L) ? Q = !1 : (L *= this.momentumDampingFactor, K *= this.momentumDampingFactor, C -= this.momentumScalingFactor * K, B -= this.momentumScalingFactor * L))
        };
        this.dollyIn = function(a) {
            void 0 === a && (a = Math.pow(.95, f.zoomSpeed));
            f.object instanceof e.PerspectiveCamera ? E /= a : f.object instanceof e.OrthographicCamera ? (f.object.zoom = Math.max(this.minZoom, Math.min(this.maxZoom, this.object.zoom * a)), f.object.updateProjectionMatrix(), f.dispatchEvent(V)) : console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.")
        };
        ...
        this.update = function(a) {
            ...
            E = 1;
            F.set(0, 0, 0);
            if (1E-7 < M.distanceToSquared(this.object.position) || 1E-7 < 8 * (1 - N.dot(this.object.quaternion))) !0 !== a && this.dispatchEvent(V), M.copy(this.object.position), N.copy(this.object.quaternion)
        };
        this.reset = function() {
            x = w.NONE;
        ...
        this.domElement.addEventListener("mousewheel", k, {
            passive: !1
        });
        this.domElement.addEventListener("DOMMouseScroll", k, {
            passive: !1
        });
        ...
        this.domElement.addEventListener("touchmove", v, {
            passive: !1
        });
    ...
    function ca(a, b) {
        ...
        this.connect = function() {
            ...
            c.domElement.addEventListener("touchmove", f, {
                passive: !1
            });
            c.enabled = !0
        };
        ...
        this.update = function(a) {
            if (!1 !== c.enabled) {
                var b = c.deviceOrientation.alpha ? e.Math.degToRad(c.deviceOrientation.alpha) + c.alphaOffsetAngle : 0,
                    ...
                    f = c.deviceOrientation.gamma ? e.Math.degToRad(c.deviceOrientation.gamma) :
                    0,
                    ...
                    D = new e.Euler,
                    q = new e.Quaternion,
                    v = new e.Quaternion(-Math.sqrt(.5), 0, 0, Math.sqrt(.5)),
                    h = new e.Quaternion,
                    r = new e.Quaternion;
                if (0 == c.screenOrientation) {
                    var n = new e.Vector3(1, 0, 0);
                    h.setFromAxisAngle(n, -k)
                } else 180 == c.screenOrientation ? (n = new e.Vector3(1, 0, 0), h.setFromAxisAngle(n, k)) : 90 == c.screenOrientation ? (n = new e.Vector3(0, 1, 0), h.setFromAxisAngle(n, k)) : -90 == c.screenOrientation && (n = new e.Vector3(0,
                    1, 0), h.setFromAxisAngle(n, -k));
                v.multiply(h);
                v.multiply(r);
                D.set(g, b, -f, "YXZ");
                m.setFromEuler(D);
    ...
    function da(a) {
        ...
        a.horizontalView =
            void 0 !== a.horizontalView ? a.horizontalView : !1;
        ...
        a.autoRotateActivationDuration =
            a.autoRotateActivationDuration || 5E3;
        this.options = a;
        if (a.container) {
            var b = a.container;
        ...
        this.scene = a.scene ||
            new e.Scene;
        this.renderer = a.renderer || new e.WebGLRenderer({
            alpha: !0,
            antialias: !1
        });
    ...
    var ja = "^0.105.2".replace(/[^0-9.]/g, ""),
        ...
        ea = {
            load: function(a, b, c, d) {
                ...
                if (void 0 !== l) return b && setTimeout(function() {
                    c({
                        loaded: 1,
                        total: 1
                    });
                ...
                if (0 === a.indexOf("data:")) return q.addEventListener("load",
                    f, !1), q.src = a, q;
                ...
                g.addEventListener("loadend", function(a) {
                    a && (k = new Uint8Array(a.currentTarget.response), p = new window.Blob([k]), q.addEventListener("load", f, !1), q.src = h.createObjectURL(p))
                });
                g.send(null)
            }
        },
    ...
    S.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        ...
        playVideo: function() {
            var a = this.element;
            a && (a.play(), this.dispatchEvent({
                type: "play"
            }))
        },
        pauseVideo: function() {
            var a = this.element;
            a && (a.pause(), this.dispatchEvent({
                type: "pause"
            }))
        },
    ...
    M.prototype =
        Object.assign(Object.create(e.Sprite.prototype), {
            constructor: M,
            setColor: function(a) {
            ...
            updateCanvasArcByProgress: function(a) {
                ...
                b.clearRect(0, 0, c, d);
                b.beginPath();
                0 === a ? (b.arc(l, k, c / 16, 0, 2 * Math.PI), b.fillStyle = m, b.fill()) : (b.arc(l, k, c / 4 - 3, -Math.PI / 2, -Math.PI / 2 + e), b.strokeStyle = m, b.lineWidth = 3, b.stroke());
                b.closePath();
                g.map.needsUpdate = !0
            },
            ripple: function() {
                var a = this,
                    ...
                    f = function() {
                        ...
                        b.fill();
                        b.closePath();
                        1 <= v && (window.cancelAnimationFrame(p), a.updateCanvasArcByProgress(0), a.dispatchEvent({
    ...
    var r = function(a, b) {
                ...
                for (b in this._valuesEnd)
                    if (void 0 !== this._valuesStart[b]) {
                        var e = this._valuesStart[b] || 0,
                            l = this._valuesEnd[b];
                        l instanceof Array ? this._object[b] = this._interpolationFunction(l, c) : ("string" === typeof l && (l = "+" === l.charAt(0) || "-" === l.charAt(0) ? e + parseFloat(l) : parseFloat(l)), "number" === typeof l && (this._object[b] = e + (l - e) * c))
                    } null !== this._onUpdateCallback && this._onUpdateCallback(this._object, d);
                if (1 === d)
                    if (0 <
                        this._repeat) {
                        isFinite(this._repeat) && this._repeat--;
                        for (b in this._valuesStartRepeat) "string" === typeof this._valuesEnd[b] && (this._valuesStartRepeat[b] += parseFloat(this._valuesEnd[b])), this._yoyo && (d = this._valuesStartRepeat[b], this._valuesStartRepeat[b] = this._valuesEnd[b], this._valuesEnd[b] = d), this._valuesStart[b] = this._valuesStartRepeat[b];
        ...
        c.Easing = {
            ...
            Elastic: {
                ...
                Out: function(a) {
                    return 0 === a ? 0 : 1 === a ?
                        1 : Math.pow(2, -10 * a) * Math.sin(5 * (a - .1) * Math.PI) + 1
                },
                InOut: function(a) {
                    if (0 === a) return 0;
                    if (1 === a) return 1;
        ...
        c.Interpolation = {
            Linear: function(a, b) {
                ...
                return 0 > b ? l(a[0], a[1], g) : 1 < b ? l(a[d], a[d - 1], d - g) : l(a[e], a[e + 1 > d ? d : e + 1], g - e)
            },
            Bezier: function(a, b) {
                for (var d = 0, g = a.length - 1, e = Math.pow, l = c.Interpolation.Utils.Bernstein, h = 0; h <=
                    g; h++) d += e(1 - b, g - h) * e(b, h) * a[h] * l(g, h);
                return d
            },
            CatmullRom: function(a, b) {
                ...
                return a[0] === a[d] ? (0 > b && (e = Math.floor(g = d * (1 + b))), l(a[(e - 1 + d) % d], a[e], a[(e + 1) % d], a[(e + 2) % d], g - e)) : 0 > b ? a[0] - (l(a[0], a[0], a[1], a[1], -g) - a[0]) : 1 < b ? a[d] - (l(a[d], a[d], a[d - 1], a[d - 1], g - d) - a[d]) : l(a[e ? e - 1 : 0], a[e], a[d < e + 1 ? d : e + 1], a[d < e + 2 ? d : e + 2], g - e)
            },
            Utils: {
    ...
    z.prototype = Object.assign(Object.create(e.Sprite.prototype), {
        ...
        onDualEyeEffect: function(a) {
            if (this.getContainer()) {
                ...
                a && (a.left || a.right || (a.left = a.cloneNode(!0), a.right = a.cloneNode(!0)), this.mode === t.CARDBOARD || this.mode === t.STEREO ? (a.left.style.display = a.style.display,
                    a.right.style.display = a.style.display, a.style.display = "none") : (a.style.display = a.left.style.display, a.left.style.display = "none", a.right.style.display = "none"), this.translateElement(b, c), this.container.appendChild(a.left), this.container.appendChild(a.right))
            }
        },
        translateElement: function(a, b) {
            if (this.element._width && this.element._height && this.getContainer()) {
                ...
                var l = b - e -
                    p;
                this.mode !== t.CARDBOARD && this.mode !== t.STEREO || !d.left || !d.right || a === c.clientWidth / 2 && b === c.clientHeight / 2 ? this.setElementStyle("transform", d, "translate(" + m + "px, " + l + "px)") : (m = c.clientWidth / 4 - g + (a - c.clientWidth / 2), l = c.clientHeight / 2 - e - p + (b - c.clientHeight / 2), this.setElementStyle("transform", d.left, "translate(" + m + "px, " + l + "px)"), m += c.clientWidth / 2, this.setElementStyle("transform", d.right, "translate(" + m + "px, " + l + "px)"))
            }
        },
        setElementStyle: function(a, b, c) {
            b = b.style;
            "transform" === a && (b.webkitTransform =
                b.msTransform = b.transform = c)
        },
        setText: function(a) {
        ...
        addHoverText: function(a, b) {
            ...
            this.element || (this.element = document.createElement("div"), this.element.style.display = "none", this.element.style.color = "#fff", this.element.style.top = 0, this.element.style.maxWidth = "50%", this.element.style.maxHeight = "50%", this.element.style.textShadow = "0 0 3px #000000", this.element.style.fontFamily = '"Trebuchet MS", Helvetica, sans-serif',
                this.element.style.position = "absolute", this.element.classList.add("panolens-infospot"), this.element.verticalDelta = b);
            this.setText(a)
        },
        addHoverElement: function(a, b) {
            b = void 0 === b ? 40 : b;
            this.element || (this.element = a.cloneNode(!0), this.element.style.display = "none", this.element.style.top = 0, this.element.style.position = "absolute", this.element.classList.add("panolens-infospot"), this.element.verticalDelta = b)
        },
        removeHoverElement: function() {
            this.element && (this.element.left && (this.container.removeChild(this.element.left),
                this.element.left = null), this.element.right && (this.container.removeChild(this.element.right), this.element.right = null), this.container.removeChild(this.element), this.element = null)
        },
        ...
        show: function(a) {
            ...
            var b = this.hideAnimation,
                ...
                d = this.material;
            this.animated ?
                (b.stop(), c.delay(a).start()) : (this.enableRaycast(!0), d.opacity = 1)
        },
        hide: function(a) {
            a = void 0 === a ? 0 : a;
            var b = this.hideAnimation,
    ...
    I.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        ...
        addControlBar: function() {
            if (this.container) {
                ...
                d.dispose = function() {
                    ...
                    a.videoElement && (d.removeChild(a.videoElement),
                        a.videoElement.dispose(), a.videoElement = null)
                };
        ...
        createDefaultMenu: function() {
            ...
            return [{
                ...
                subMenu: [{
                    ...
                    title: "Cardboard",
                    handler: b("enableEffect", t.CARDBOARD)
                }, {
                    title: "Stereoscopic",
        ...
        createFullscreenButton: function() {
            function a() {
                d && (c = !c, e.style.backgroundImage = c ? 'url("' + u.FullscreenLeave +
            ...
            if (document.fullscreenEnabled || document.webkitFullscreenEnabled || document.mozFullScreenEnabled || document.msFullscreenEnabled) {
                ...
                var e =
                    this.createCustomItem({
                        style: {
                            backgroundImage: 'url("' + u.FullscreenEnter + '")'
                        },
                        onTap: function(a) {
                            a.preventDefault();
                            a.stopPropagation();
                            d = !1;
                            c ? (document.exitFullscreen && document.exitFullscreen(), document.msExitFullscreen && document.msExitFullscreen(), document.mozCancelFullScreen && document.mozCancelFullScreen(), document.webkitExitFullscreen && document.webkitExitFullscreen(), c = !1) : (g.requestFullscreen && g.requestFullscreen(), g.msRequestFullscreen && g.msRequestFullscreen(), g.mozRequestFullScreen && g.mozRequestFullScreen(),
                                g.webkitRequestFullscreen && g.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT), c = !0);
        ...
        createVideoControl: function() {
            ...
            this.addEventListener("video-control-hide",
                a.hide);
            return a
        },
        ...
        createVideoControlSeekbar: function() {
            ...
            function b(a) {
                e && (l = ((a.clientX || a.changedTouches && a.changedTouches[0].clientX) - p) / f.clientWidth, l = m + l, l = 1 < l ? 1 :
                    0 > l ? 0 : l, f.setProgress(l), g.dispatchEvent({
                        type: "panolens-viewer-handler",
        ...
        createMainMenu: function(a) {
            ...
            for (var e = 0; e < a.length; e++) {
                ...
                k.addIcon().addEventListener(c.TOUCH_ENABLED ?
                    "touchend" : "click", b, !1);
                a[e].subMenu && 0 < a[e].subMenu.length && k.addSelection(a[e].subMenu[0].title).addSubMenu(a[e].title, a[e].subMenu)
            }
            return d
        },
        createSubMenu: function(a, b) {
            ...
            k.items = b;
            k.activeItem = null;
            k.addHeader(a).addIcon(void 0,
                !0, !0).addEventListener(d.TOUCH_ENABLED ? "touchend" : "click", c, !1);
    ...
    n.prototype = Object.assign(Object.create(e.Mesh.prototype), {
        ...
        add: function(a) {
            ...
            e.Object3D.prototype.add.call(this,
                b)
        },
        load: function() {
            this.onLoad()
        ...
        setContainer: function(a) {
            ...
            b && (this.children.forEach(function(a) {
                a instanceof z && a.dispatchEvent && a.dispatchEvent({
                    type: "panolens-container",
                    container: b
                })
            }), this.container = b)
        ...
        toggleInfospotVisibility: function(a, b) {
            b = void 0 !== b ? b : 0;
            var c = void 0 !==
                a ? a : this.isInfospotVisible ? !1 : !0;
        ...
        link: function(a, b, c, d) {
            this.visible = !0;
            b ? (c = void 0 !== c ? c : void 0 !== a.linkingImageScale ? a.linkingImageScale : 300, d = d ? d : a.linkingImageURL ? a.linkingImageURL : u.Arrow,
                d = new z(c, d), d.position.copy(b), d.toPanorama = a, d.addEventListener("click", function() {
                    this.dispatchEvent({
                        type: "panolens-viewer-handler",
                        method: "setPanorama",
                        data: a
                    })
                }.bind(this)), this.linkedSpots.push(d), this.add(d), this.visible = !1) : console.warn("Please specify infospot position for linking")
        },
        reset: function() {
        ...
        dispose: function() {
            function a(b) {
                for (var c = b.geometry, d = b.material, e = b.children.length - 1; 0 <= e; e--) a(b.children[e]), b.remove(b.children[e]);
    ...
    y.prototype = Object.assign(Object.create(n.prototype), {
        ...
        load: function(a) {
            ...
            else if ("string" === typeof a) N.load(a, this.onLoad.bind(this), this.onProgress.bind(this), this.onError.bind(this));
    ...
    F.prototype = Object.assign(Object.create(n.prototype), {
        constructor: F,
        load: function() {
            fa.load(this.images, this.onLoad.bind(this),
    ...
    O.prototype = Object.assign(Object.create(F.prototype), {
        constructor: O
    });
    B.prototype = Object.assign(Object.create(n.prototype), {
        ...
        load: function() {
            ...
            e = function() {
                ...
                this.isMobile() &&
                    (k.pause(), d && b ? this.dispatchEvent({
                        type: "panolens-viewer-handler",
                        method: "updateVideoPlayButton",
                        data: !1
                    }) : this.dispatchEvent({
            ...
            2 < k.readyState ? e.call(this) : (0 === k.querySelectorAll("source").length && (a = document.createElement("source"), a.src = this.src, k.appendChild(a)), k.load());
            ...
            k.addEventListener("ended", function() {
                c || (this.resetVideo(), this.dispatchEvent({
                    type: "panolens-viewer-handler",
                    method: "updateVideoPlayButton",
                    data: !0
                }))
        ...
        setVideoCurrentTime: function(a) {
            ...
            b && !Number.isNaN(a) && 1 !== a && (b.currentTime = b.duration * a, this.dispatchEvent({
                type: "panolens-viewer-handler",
                method: "onVideoUpdate",
                data: a
            }))
        ...
        resumeVideoProgress: function() {
            var a = this.videoElement;
            4 <= a.readyState && a.autoplay && !this.isMobile() ? (this.playVideo(), this.dispatchEvent({
                type: "panolens-viewer-handler",
                method: "updateVideoPlayButton",
                data: !1
    ...
    Object.assign(P.prototype, {
        ...
        composeFromTile: function(a, b, c) {
            ...
            var k = Math.floor(a / d),
                h = Math.floor(b / e);
            this._ctx[h *
                this._wc + k].drawImage(c, 0, 0, c.width, c.height, a - k * d, b - h * e, 512, 512);
            this.progress()
        },
        progress: function() {
            this._count++;
            this.setProgress(this._count, this._total);
            if (this._count === this._total && (this.canvas = this._canvas, this.panoId = this._panoId, this.zoom = this._zoom, this.onPanoramaLoad)) this.onPanoramaLoad(this._canvas[0])
        },
        composePanorama: function() {
            ...
            this._count = 0;
            this._total = a * b;
            for (var d = this._parameters.useWebGL, e =
                    0; e < b; e++)
                for (var k = {}, h = 0; h < a; k = {
                        $jscomp$loop$prop$url$1: k.$jscomp$loop$prop$url$1
                    }, h++) k.$jscomp$loop$prop$url$1 = "https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom=" + this._zoom + "&x=" + h + "&y=" + e + "&panoid=" + this._panoId + "&nbt&fover=2",
                    function(a) {
                        return function(b, e) {
                            if (d) var g = N.load(a.$jscomp$loop$prop$url$1, null, function() {
        ...
        loadPano: function(a) {
            ...
            this._panoClient.getPanoramaById(a, function(a, d) {
                d === google.maps.StreetViewStatus.OK && (b.result = a, b.copyright = a.copyright, b._panoId = a.location.pano, b.composePanorama())
            })
        },
        setZoom: function(a) {
            this._zoom = a;
    ...
    C.prototype = Object.assign(Object.create(y.prototype), {
        ...
        onMouseMove: function(a) {
            switch (a.touches && a.touches.length || 1) {
                case 1:
                    var b = 0 <= a.clientX ? a.clientX :
                        a.touches[0].clientX;
                    a = 0 <= a.clientY ? a.clientY : a.touches[0].clientY;
                    var c = .4 * e.Math.degToRad(b - this.userMouse.x),
                        d = .4 * e.Math.degToRad(a - this.userMouse.y);
    ...
    da.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        ...
        add: function(a) {
            ...
            a instanceof n && a.dispatchEvent && a.dispatchEvent({
                type: "panolens-container",
                container: this.container
            });
            a instanceof J && a.dispatchEvent({
                type: "panolens-scene",
                scene: this.scene
            });
        ...
        remove: function(a) {
            a.removeEventListener && a.removeEventListener("panolens-viewer-handler",
        ...
        setPanorama: function(a) {
            ...
            if ("panorama" === a.type && b !== a) {
                ...
                var c = function() {
                    if (b) b.onLeave();
                    a.removeEventListener("enter-fade-start",
                        c)
                };
        ...
        disableEffect: function() {
            this.mode !== t.NORMAL && (this.mode = t.NORMAL, this.disableReticleControl(), this.activateWidgetItem(void 0,
                this.mode), this.dispatchEventToChildren({
                type: "panolens-dual-eye-effect",
                mode: this.mode
        ...
        disableReticleControl: function() {
            ...
            this.options.enableReticle ?
                this.updateReticleEvent() : (this.reticle.hide(), this.unregisterReticleEvent(), this.registerMouseAndTouchEvents())
        },
        ...
        toggleVideoPlay: function(a) {
            this.panorama instanceof B && this.panorama.dispatchEvent({
                type: "video-toggle",
                pause: a
            })
        },
        ...
        tweenControlCenter: function(a, b, c) {
            ...
            if (this.control === this.OrbitControls) {
                ...
                this.tweenLeftAnimation = (new r.Tween(h)).to({
                        left: m
                    },
                ...
                this.tweenUpAnimation = (new r.Tween(h)).to({
                    up: k
                }, b).easing(c).onUpdate(function(a) {
        ...
        outputPosition: function() {
            ...
            if (0 < a.length) {
                ...
                if (0 !== a.length()) switch (this.options.output) {
                    case "console":
                        console.info(b);
                        break;
                    case "overlay":
        ...
        onMouseUp: function(a) {
            ...
            var b = this.userMouse.x >= a.clientX - this.options.clickTolerance && this.userMouse.x <= a.clientX +
                this.options.clickTolerance && this.userMouse.y >= a.clientY - this.options.clickTolerance && this.userMouse.y <= a.clientY + this.options.clickTolerance || a.changedTouches && this.userMouse.x >= a.changedTouches[0].clientX - this.options.clickTolerance && this.userMouse.x <= a.changedTouches[0].clientX + this.options.clickTolerance && this.userMouse.y >= a.changedTouches[0].clientY - this.options.clickTolerance && this.userMouse.y <= a.changedTouches[0].clientY + this.options.clickTolerance ? "click" : void 0;
            if (!a || !a.target || a.target.classList.contains("panolens-canvas"))
                if (a.preventDefault(),
                    ...
                    }, b) : this.onTap(a, b), this.userMouse.type = "none", !a && "click" === b) {
                    b = this.options;
        ...
        onTap: function(a, b) {
            var c = this.container.getBoundingClientRect(),
                ...
                e = this.container,
                h = e.clientHeight;
            this.raycasterPoint.x = (a.clientX - c.left) / e.clientWidth *
                2 - 1;
            ...
            if (this.panorama) {
                ...
                "mouseup" === this.userMouse.type && (e && this.pressObject === e && this.pressObject.dispatchEvent && this.pressObject.dispatchEvent({
                    type: "pressstop",
                    mouseEvent: a
                }), this.pressObject = void 0);
                if ("click" === b) this.panorama.dispatchEvent({
                    type: "click",
                    intersects: c,
                    mouseEvent: a
                    ...
                    type: "click-entity",
                    mouseEvent: a
                }), e && e.dispatchEvent && e.dispatchEvent({
                    type: "click",
                    mouseEvent: a
                });
                else {
                    ...
                    if (this.hoverObject && 0 < c.length && this.hoverObject !== d || this.hoverObject && 0 === c.length) this.hoverObject.dispatchEvent && (this.hoverObject.dispatchEvent({
                        type: "hoverleave",
                        mouseEvent: a
                    }), this.reticle.end()), this.hoverObject = void 0;
                    d && 0 < c.length && (this.hoverObject !== d && (this.hoverObject = d, this.hoverObject.dispatchEvent && (this.hoverObject.dispatchEvent({
                        type: "hoverenter",
                        mouseEvent: a
                    }), (this.options.autoReticleSelect && this.options.enableReticle || this.tempEnableReticle) && this.reticle.start(this.onTap.bind(this,
                        a, "click")))), "mousedown" === this.userMouse.type && this.pressEntityObject != d && (this.pressEntityObject = d, this.pressEntityObject.dispatchEvent && this.pressEntityObject.dispatchEvent({
                        type: "pressstart-entity",
                        mouseEvent: a
                    })), "mousedown" === this.userMouse.type && this.pressObject != e && (this.pressObject = e, this.pressObject.dispatchEvent && this.pressObject.dispatchEvent({
                        type: "pressstart",
                        mouseEvent: a
                    })), "mousemove" === this.userMouse.type || this.options.enableReticle) && (e && e.dispatchEvent && e.dispatchEvent({
                        type: "hover",
                        mouseEvent: a
                    ...
                    !e && this.pressObject && this.pressObject.dispatchEvent && (this.pressObject.dispatchEvent({
                        type: "pressstop",
                        mouseEvent: a
                    }), this.pressObject = void 0)
                }
        ...
        getConvertedIntersect: function(a) {
            for (var b, c = 0; c < a.length; c++)
                if (0 <=
                    a[c].distance && a[c].object && !a[c].object.passThrough && (!a[c].object.entity || !a[c].object.entity.passThrough)) {
        ...
        addViewIndicator: function() {
            ...
            this.loadAsyncRequest(u.ViewIndicator, function(b) {
                if (0 !== b.loaded) {
                    ...
                    b.style.width = a.viewIndicatorSize +
                        "px";
                    ...
                    a.addUpdateCallback(function() {
                        ...
                        a.rightAngle = -a.currentPanoAngle +
                            a.fovAngle / 2;
        ...
        appendControlItem: function(a) {
            var b =
                this.widget.createCustomItem(a);
